...
<br>
<%
out.print("<h3 align=\"center\">"+"Date Format -- "+"20160411205922:(YYYY)(MM)(DD)(HH)(MIN)(SS)"+"</h3>");
%>
	<form action="DataRange.jsp">

                <table style="color:Blue">

                    <tr>

                        <td> From Date  : </td><td> <input name="fd" size=20 type="text" /> </td> 

                    </tr>

                    <tr>

                        <td> To Date  : </td><td> <input name="td" size=20 type="text" /> </td> 
	...
	<%
		...
		try{
			...
			long fdt = Long.parseLong((request.getParameter("fd")).trim()) ;
			
	       long ldt = Long.parseLong((request.getParameter("td")).trim());
	       
	        BasicDBObject getQuery = new BasicDBObject();
	        	       
	        
		    getQuery.put("2", new BasicDBObject("$gt",fdt).append("$lt", ldt));
		   ...
		   while(cursor.hasNext()) {
		    ...
		    out.print("<h2 align=\"right\">" +"No. of records:"+cursor.count()+ "</h2>");
		}
		catch(Exception e)
